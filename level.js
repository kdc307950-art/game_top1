...
/** 19.5：地图上每关的显式**世界**坐标（x 相对 `width`、y 相对世界总高，都是归一化 0–1；
 *  0 = 世界顶部、1 = 世界底部）。与 `LEVELS.md` §9 的坐标表逐项一致，由 `_build/check-vine-map.mjs` 反向巡检。
 *  节点坐标是**显式**的、**不参与路径计算**（D040 的取舍在 19.5 仍然成立）。 */
export const LEVEL_MAP_POS = Object.freeze([
  Object.freeze({ id: 1, x: 0.2, y: 0.9 }),
  Object.freeze({ id: 2, x: 0.48, y: 0.88 }),
  Object.freeze({ id: 3, x: 0.76, y: 0.87 }),
  Object.freeze({ id: 4, x: 0.2, y: 0.85 }),
  Object.freeze({ id: 5, x: 0.48, y: 0.84 }),
  Object.freeze({ id: 6, x: 0.76, y: 0.82 }),
  Object.freeze({ id: 7, x: 0.2, y: 0.81 }),
  Object.freeze({ id: 8, x: 0.48, y: 0.79 }),
  Object.freeze({ id: 9, x: 0.76, y: 0.78 }),
  Object.freeze({ id: 10, x: 0.2, y: 0.76 }),
  Object.freeze({ id: 11, x: 0.48, y: 0.75 }),
  Object.freeze({ id: 12, x: 0.76, y: 0.73 }),
  Object.freeze({ id: 13, x: 0.2, y: 0.72 }),
  Object.freeze({ id: 14, x: 0.48, y: 0.7 }),
  Object.freeze({ id: 15, x: 0.76, y: 0.69 }),
  Object.freeze({ id: 16, x: 0.2, y: 0.67 }),
  Object.freeze({ id: 17, x: 0.48, y: 0.66 }),
  Object.freeze({ id: 18, x: 0.76, y: 0.64 }),
  Object.freeze({ id: 19, x: 0.2, y: 0.63 }),
  Object.freeze({ id: 20, x: 0.48, y: 0.61 }),
  Object.freeze({ id: 21, x: 0.76, y: 0.6 }),
  Object.freeze({ id: 22, x: 0.2, y: 0.58 }),
  Object.freeze({ id: 23, x: 0.48, y: 0.57 }),
  Object.freeze({ id: 24, x: 0.76, y: 0.55 }),
  Object.freeze({ id: 25, x: 0.2, y: 0.54 }),
  Object.freeze({ id: 26, x: 0.48, y: 0.52 }),
  Object.freeze({ id: 27, x: 0.76, y: 0.51 }),
  Object.freeze({ id: 28, x: 0.2, y: 0.49 }),
  Object.freeze({ id: 29, x: 0.48, y: 0.48 }),
  Object.freeze({ id: 30, x: 0.76, y: 0.46 }),
  Object.freeze({ id: 31, x: 0.2, y: 0.45 }),
  Object.freeze({ id: 32, x: 0.48, y: 0.43 }),
  Object.freeze({ id: 33, x: 0.76, y: 0.42 }),
  Object.freeze({ id: 34, x: 0.2, y: 0.4 }),
  Object.freeze({ id: 35, x: 0.48, y: 0.39 }),
  Object.freeze({ id: 36, x: 0.76, y: 0.37 }),
  Object.freeze({ id: 37, x: 0.2, y: 0.36 }),
  Object.freeze({ id: 38, x: 0.48, y: 0.34 }),
  Object.freeze({ id: 39, x: 0.76, y: 0.33 }),
  Object.freeze({ id: 40, x: 0.2, y: 0.31 }),
  Object.freeze({ id: 41, x: 0.48, y: 0.3 }),
  Object.freeze({ id: 42, x: 0.76, y: 0.28 }),
  Object.freeze({ id: 43, x: 0.2, y: 0.27 }),
  Object.freeze({ id: 44, x: 0.48, y: 0.25 }),
  Object.freeze({ id: 45, x: 0.76, y: 0.24 }),
  Object.freeze({ id: 46, x: 0.2, y: 0.22 }),
  Object.freeze({ id: 47, x: 0.48, y: 0.21 }),
  Object.freeze({ id: 48, x: 0.76, y: 0.19 }),
  Object.freeze({ id: 49, x: 0.2, y: 0.18 }),
  Object.freeze({ id: 50, x: 0.48, y: 0.16 }),
  Object.freeze({ id: 51, x: 0.76, y: 0.15 }),
  Object.freeze({ id: 52, x: 0.2, y: 0.13 }),
  Object.freeze({ id: 53, x: 0.48, y: 0.12 }),
]);
// ==== /LEVEL_MAP_POS ====
